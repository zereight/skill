---
name: zereight-react-native-testing
description: Write tests using React Native Testing Library (RNTL) v13/v14. Covers render, screen, queries, Jest matchers, userEvent, fireEvent, waitFor, and async patterns. Use when writing, reviewing, or fixing React Native component tests.
---
